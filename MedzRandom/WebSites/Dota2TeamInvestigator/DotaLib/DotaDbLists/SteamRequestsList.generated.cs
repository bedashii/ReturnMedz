...
{
    public partial class SteamRequestsList : List<Business.SteamRequests>
    {
        Data.SteamRequestsData _data = new Data.SteamRequestsData();
        private static Dictionary<string, SteamRequests> _lookupList = new Dictionary<string, SteamRequests>();
        ...
        /// </summary>
        /// <returns></returns>
        public SteamRequests GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    SteamRequests lookupItem = _lookupList[pkKey];
                ...
                {
                    SteamRequests lookupItem = new SteamRequests(iD);
