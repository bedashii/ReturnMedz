...
{
    public partial class TeamPlayersList : List<Business.TeamPlayers>
    {
        Data.TeamPlayersData _data = new Data.TeamPlayersData();
        private static Dictionary<string, TeamPlayers> _lookupList = new Dictionary<string, TeamPlayers>();
        ...
        /// </summary>
        /// <returns></returns>
        public TeamPlayers GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    TeamPlayers lookupItem = _lookupList[pkKey];
                ...
                {
                    TeamPlayers lookupItem = new TeamPlayers(iD);
