...
{
    public partial class RequestTrackingList : List<Business.RequestTracking>
    {
        Data.RequestTrackingData _data = new Data.RequestTrackingData();
        private static Dictionary<string, RequestTracking> _lookupList = new Dictionary<string, RequestTracking>();
        ...
        /// </summary>
        /// <returns></returns>
        public RequestTracking GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    RequestTracking lookupItem = _lookupList[pkKey];
                ...
                {
                    RequestTracking lookupItem = new RequestTracking(iD);
