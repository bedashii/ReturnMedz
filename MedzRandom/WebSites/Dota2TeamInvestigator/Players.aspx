<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Players.aspx.cs" Inherits="Players" %>

<%--<%@ Reference Control="~/PlayerControl.ascx" %>--%>
<%--<%@ Register Src="PlayerControl.ascx" TagName="PC" TagPrefix="PC" %>--%>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanelPlayers">
            <ContentTemplate>
                ...
                <asp:ListView runat="server" ID="ListViewPlayers"
                    ...
                    <ItemTemplate>
                        <td>
                            <DotaUC:PlayerControl runat="server" Player="<%# Container.DataItem %>" />
                        </td>
                    </ItemTemplate>
                    <EmptyItemTemplate>
                    </EmptyItemTemplate>
