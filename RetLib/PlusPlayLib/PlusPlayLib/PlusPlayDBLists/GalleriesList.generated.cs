...
namespace PlusPlayDBGenLib.Lists
{
    ...
    {
        Data.GalleriesData _data = new Data.GalleriesData();
        private static Dictionary<string, Galleries> _lookupList = new Dictionary<string, Galleries>();
        ...
        /// </summary>
        /// <returns></returns>
        public Galleries GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    Galleries lookupItem = _lookupList[pkKey];
                ...
                {
                    Galleries lookupItem = new Galleries(iD);
