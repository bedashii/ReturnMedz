...
namespace TempDataGenLib.Data
{
    ...
    public class DataProcessHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                if (_connectionString == null)
                    return System.Configuration.ConfigurationManager.AppSettings.Get("TempData Connection String");
                else
        ...
        public UpdateProperties ExecuteAndReturn(SqlCommand cmd)
        {
            ...
            up.Identity = Convert.ToInt64(dt.Rows[0]["ID"]);
            up.RowsAffected = Convert.ToInt32(dt.Rows[0]["RowCount"]);
