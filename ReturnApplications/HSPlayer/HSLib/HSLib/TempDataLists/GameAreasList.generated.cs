...
{
    public partial class GameAreasList : List<Business.GameAreas>
    {
        Data.GameAreasData _data = new Data.GameAreasData();
        private static Dictionary<string, GameAreas> _lookupList = new Dictionary<string, GameAreas>();
        ...
        /// </summary>
        /// <returns></returns>
        public GameAreas GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    GameAreas lookupItem = _lookupList[pkKey];
                ...
                {
                    GameAreas lookupItem = new GameAreas(iD);
