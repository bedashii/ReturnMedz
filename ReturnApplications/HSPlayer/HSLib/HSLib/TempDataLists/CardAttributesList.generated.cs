...
{
    public partial class CardAttributesList : List<Business.CardAttributes>
    {
        Data.CardAttributesData _data = new Data.CardAttributesData();
        private static Dictionary<string, CardAttributes> _lookupList = new Dictionary<string, CardAttributes>();
        ...
        /// </summary>
        /// <returns></returns>
        public CardAttributes GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    CardAttributes lookupItem = _lookupList[pkKey];
                ...
                {
                    CardAttributes lookupItem = new CardAttributes(iD);
