...
{
    public partial class AttributeTypesList : List<Business.AttributeTypes>
    {
        Data.AttributeTypesData _data = new Data.AttributeTypesData();
        private static Dictionary<string, AttributeTypes> _lookupList = new Dictionary<string, AttributeTypes>();
        ...
        /// </summary>
        /// <returns></returns>
        public AttributeTypes GetByPrimaryKey(int iD)
        {
            ...
            lock (_lookupList)
            {
                ...
                {
                    AttributeTypes lookupItem = _lookupList[pkKey];
                ...
                {
                    AttributeTypes lookupItem = new AttributeTypes(iD);
